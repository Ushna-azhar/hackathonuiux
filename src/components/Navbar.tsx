    ...
    <div>
      ...
      <div className="bg-white py-4 shadow-lg">
        <div className="max-w-screen-xl mx-auto px-6 flex justify-between items-center">
          {/* Left Section: Logo */}
          <div className="text-2xl text-black font-extrabold" style={{ fontFamily: 'sans-serif' }}>
          ...
          <div className="hidden md:flex space-x-10">
            ...
            <Link href="/casual" className="text-black hover:text-gray-400">
              On Sale
            </Link>
            <Link href="/newarrivals" className="text-black hover:text-gray-400">
              New Arrivals
            </Link>
